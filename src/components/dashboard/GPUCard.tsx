...
export default function GPUCard({
  ...
  return (
    <div className='bg-gray-900 rounded-lg border border-gray-800 p-4'>
      {/* Header */}
      <div className='mb-4'>
        <h3 className='text-white font-semibold text-lg mb-1'>{model}</h3>
      ...
      <div className='flex space-x-1 mb-4'>
        <button className='flex-1 bg-gray-800 hover:bg-gray-700 text-white text-sm py-2 px-2 rounded border border-gray-700'>
          x1
        </button>
        <button className='flex-1 bg-white hover:bg-gray-100 text-black text-sm py-2 px-2 rounded font-medium'>
          x2
        </button>
        <button className='flex-1 bg-gray-800 hover:bg-gray-700 text-white text-sm py-2 px-2 rounded border border-gray-700'>
          x4
      ...
      <button className='w-full bg-white hover:bg-gray-100 text-black py-2 rounded font-medium'>
        Rent Now
      </button>
    </div>
  );
